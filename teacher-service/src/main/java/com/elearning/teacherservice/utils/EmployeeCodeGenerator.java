...
public class EmployeeCodeGenerator  extends SequenceStyleGenerator {
    ...
    public Serializable generate(SharedSessionContractImplementor session,
        ...
        String f = String.valueOf(((Teacher)object).getFname().charAt(0));
        String l = String.valueOf(((Teacher)object).getLname().charAt(0));
